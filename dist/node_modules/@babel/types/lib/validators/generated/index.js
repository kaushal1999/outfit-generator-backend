...
function isNumberLiteral(node, opts) {
  console.trace("`isNumberLiteral` has been deprecated, please migrate to `isNumericLiteral`.");
  if (!node) return false;
  const nodeType = node.type;
...
function isRegexLiteral(node, opts) {
  console.trace("`isRegexLiteral` has been deprecated, please migrate to `isRegExpLiteral`.");
  if (!node) return false;
  const nodeType = node.type;
...
function isRestProperty(node, opts) {
  console.trace("`isRestProperty` has been deprecated, please migrate to `isRestElement`.");
  if (!node) return false;
  const nodeType = node.type;
...
function isSpreadProperty(node, opts) {
  console.trace("`isSpreadProperty` has been deprecated, please migrate to `isSpreadElement`.");
  if (!node) return false;
  const nodeType = node.type;
...
function isModuleDeclaration(node, opts) {
  console.trace("`isModuleDeclaration` has been deprecated, please migrate to `isImportOrExportDeclaration`.");
